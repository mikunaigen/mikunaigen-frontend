    ...
    <div class="rb-page">
      <div class="rb-container">
        <div class="rb-card overflow-hidden">
          <div
            class="border-b border-white/10 bg-secondary px-4 py-6 text-white dark:bg-slate-800 sm:px-6 sm:py-7 lg:px-8"
          >
          ...
          <div class="p-4 sm:p-6 lg:p-8">
            <section class="rb-section-muted">
              <div
                class="flex flex-col items-center justify-center gap-4 rounded-xl border border-gray-200 bg-white p-6 text-center dark:border-dark-border dark:bg-dark-surface sm:p-8"
              >
                <div class="flex items-center justify-center gap-3">
                  ...
                  <div class="rb-modal-icon !mb-0" [class.animate-pulse]="!maintenance.esAdministradorRestaurando()">
                    <ng-icon
                      name="heroCog6Tooth"
                      size="48"
                      class="text-secondary dark:text-blue-400"
                    />
                  </div>
                </div>
